...
def qExit():
    qExit = messagebox.askyesno("Quit System",
                                "Do you want to quit? \n Project By :\n 1) Tanisha Katyal   Roll no : 16 \n 2) Shrinjay Kaushik   Roll no : 17 \n 3) Aryan Kawli   Roll no : 18 \n 4) Harsh Keniel   Roll no : 19 \n 5)Khan Mohammad Aamir  Roll No : 20 \nThank You.....!!")
    if qExit > 0:
        root.destroy()
        return
